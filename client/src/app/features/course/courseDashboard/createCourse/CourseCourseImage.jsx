function CourseCourseImage({ handleFileChange }) {
  return (
    <label className="flex flex-col items-center gap-5 cursor-pointer border-2 border-dashed border-gray-300 bg-primary-500 p-6 rounded-lg shadow-md h-96 justify-center relative z-50">
      ...
      <div className="flex items-center justify-center">
        <span className="font-normal text-text">click to upload image</span>
      </div>
      <input type="file" name="courseImage" onChange={handleFileChange} className="hidden" />
    </label >
  )
}
