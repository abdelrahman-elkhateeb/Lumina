function CourseCourseImage({ handleFileChange }) {
  return (
    <label className="flex flex-col items-center gap-5 cursor-pointer border-2 border-dashed border-gray-300 bg-primary-500 p-6 rounded-lg shadow-md h-96 justify-center">
